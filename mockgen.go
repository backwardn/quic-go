...
//go:generate sh -c "mockgen -package quic -destination mock_token_cache_test.go github.com/lucas-clemente/quic-go TokenCache && sed -i '' 's/quic_go.//g' mock_token_cache_test.go && goimports -w mock_token_cache_test.go"
